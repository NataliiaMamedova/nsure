...
use App\MessageHandler\Internal\EmailVerificationEventMessageHandler;
use App\VO\DeviceId;
use App\VO\Email;
use App\VO\IP;
 ...
 * @internal
 */
class EmailVerificationEventMessageHandlerTest extends KernelTestCase
{
    ...
    public function testMerchantFinalDecisionRequestSuccess(): void
    {
        ...
        $messageHandler = self::getContainer()->get(EmailVerificationEventMessageHandler::class);
        ...
        self::assertSame('c.kent@example.com', $requestData['verificationAttempt']['email']);
        ...
        self::assertSame('emailVerification', $requestData['metadata']['type']);
        self::assertSame('192.168.10.55', $requestData['sessionInfo']['ip']);
    }

    private function createMessage(): EmailVerificationEventMessage
    {
        return EmailVerificationEventMessage::create(
