...
use App\MessageHandler\Internal\PhoneVerificationEventMessageHandler;
use App\VO\DeviceId;
use App\VO\IP;
 ...
 * @internal
 */
class PhoneVerificationEventMessageHandlerTest extends KernelTestCase
{
    ...
    public function testMerchantFinalDecisionRequestSuccess(): void
    {
        ...
        $messageHandler = self::getContainer()->get(PhoneVerificationEventMessageHandler::class);
        ...
        self::assertSame('5211178455', $requestData['verificationAttempt']['phone']);
        self::assertSame('44', $requestData['verificationAttempt']['countryCode']);
        ...
        self::assertSame('phoneVerification', $requestData['metadata']['type']);
        self::assertSame('192.168.10.55', $requestData['sessionInfo']['ip']);
    }

    private function createMessage(): PhoneVerificationEventMessage
    {
        return PhoneVerificationEventMessage::create(
