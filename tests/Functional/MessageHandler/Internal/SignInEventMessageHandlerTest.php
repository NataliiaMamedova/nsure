...
use App\MessageHandler\Internal\SignInEventMessageHandler;
use App\VO\DeviceId;
use App\VO\IP;
 ...
 * @internal
 */
class SignInEventMessageHandlerTest extends KernelTestCase
{
    ...
    public function testSignInEventRequestSuccess(): void
    {
        ...
        $messageHandler = self::getContainer()->get(SignInEventMessageHandler::class);
        ...
        self::assertSame('signIn', $requestData['metadata']['type']);
        self::assertSame('192.168.10.55', $requestData['sessionInfo']['ip']);
    }

    private function createMessage(): SignInEventMessage
    {
        return SignInEventMessage::create(
